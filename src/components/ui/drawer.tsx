      ...
      >
        <div className="py-8 px-6">
          <div className="flex items-center justify-between w-full">
            ...
            <button
              onClick={onClose}
              className="text-md rounded-sm bg-[#f5f5f5] p-2 text-black font-medium transition-transform active:scale-95"
            >
              Close
            </button>
          </div>

          <div className="mt-4 max-w-xl font-semibold text-[1.4rem] leading-7">
            <p className="w-full">
          ...
          <div className="mt-6 relative min-h-[400px]">
            {/* scattered words */}
            <span className="absolute top-6 left-8 text-6xl font-bold text-[#F472B6] select-none">
              listen
            </span>
            <span className="absolute top-1/3 right-6 text-6xl font-bold text-[#F472B6] select-none">
              create
            </span>
            <span className="absolute bottom-80 left-4 text-6xl font-bold text-[#F472B6] select-none">
              obsess
            </span>
            <span className="absolute bottom-10 right-6 text-6xl font-bold text-[#F472B6] select-none">
              inspire
            </span>
